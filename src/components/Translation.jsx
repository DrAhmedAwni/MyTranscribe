...
export default function Translation(props) {
    ...
    return (
        <>
            ...
            {!translating && (<div className='flex flex-col gap-3 mb-4 overflow-hidden'>
                <div className='flex flex-col gap-1'>
                    <p className='text-xs sm:text-sm font-medium text-slate-500 mr-auto'>From language</p>
                    <select value={fromLanguage} className='flex-1 outline-none w-full focus:outline-none bg-white duration-200 p-2 rounded' onChange={(e) => setFromLanguage(e.target.value)}>
